...
- `editor`: Monaco Editor Core. The full [Monaco Editor](https://microsoft.github.io/monaco-editor/) is defined in a separate repo https://github.com/microsoft/monaco-editor, which adds some programming language features on top of the Monaco Editor Core and publishes the combination as a package.
