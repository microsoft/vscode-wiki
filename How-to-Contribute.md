...
- For Codespaces, install the [Visual Studio Codespaces](https://visualstudio.microsoft.com/it/services/github-codespaces/) extension in VS Code, and use the **Codespaces: Create New Codespace** command.
