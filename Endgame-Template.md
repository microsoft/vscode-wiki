...
- [ ] If no Patch Tuesday release is planned, [let the Updates team know of that fact](https://github.com/microsoft/vscode-internalbacklog/wiki/Patch-Tuesday-E-Mail-Template#no-patch-tuesday-release) ([CSEClientPatching@microsoft.com](mailto:CSEClientPatching@microsoft.com))